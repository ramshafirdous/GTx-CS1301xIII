...
def one_dimensional_booleans(bool_list,use_and):
    ...
    index_2= bool_list[1]
    for i in bool_list:
        if use_and== True and index==index_1==index_2==True:
            return True
        elif use_and== True and False in bool_list:
            return False
        elif use_and== False and True in bool_list:
            return True
        elif use_and== False and index==index_1==index_2==False:
            return False
