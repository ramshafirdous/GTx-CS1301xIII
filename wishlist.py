...
def wish_list(a_list,a_str,my_float1, my_float2):
    if a_str in a_list and my_float2 >= my_float1:
        return ("You should buy a "+a_str+"!")
    elif a_str in a_list and my_float2 < my_float1:
        return ("You should save up for a "+a_str+"!")
    elif a_str not in a_list:
        return ("You probably don't want to buy a "+a_str+".")
